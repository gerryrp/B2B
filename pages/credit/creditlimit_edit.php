        ...
        <div class="container w-full mt-3 ">
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            <input type="text" class="textareaxl border border-black" value="AMMAN MINERAL NUSA TENGGARA">
                            <button class="btn btn-sm btn-rounded btn-light"><i class="fas fa-search ml-2"></i>	</button> 
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            IDR &nbsp<input type="text" class="textareasm border border-black" value="433,000,000">
                        </div>
