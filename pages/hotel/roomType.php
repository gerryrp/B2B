...
<div class="container w-11/12 mx-auto">
        ...
        <div class="container max-w-full">
            ...
            <div class="w-full border-0 border-b border-solid border-gray-400">
                <div class="flex md-4">
                    <span class="span_title"><h2>Room Type List</h2></span>           
                </div>
            </div>
                                ...
                                <div class="bg-gray-400 w-full " >
                                    <div class="table" id="results">
                                            <div class='theader'>
                                              ...
                                              <div class='table_header'>Additional</div>
                                            ...
                                            <div class='table_row'>
                                                ...
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Additional</div>
                                                    <div class='table_cell'></div>
                                                </div>
                                                <div class='table_small'>
                                            ...
                                            <div class='table_row'>
                                                ...
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Room Type</div>
                                                    <div class='table_cell'>
                                                      <span onclick="window.location.href = '<?=root_path?>/pages/hotel/roomType_detail.php';" class="span_blue_link"> 2 BED MANGGAR VILLAS</span> 
                                                    </div>
                                                </div>
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Additional</div>
                                                ...
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Description</div>
                                                    <div class='table_cell'>2 BED MANGGAR VILLAS</div>
                                                </div>
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Group Type</div>
                                                    <div class='table_cell'>2 BED MANGGAR VILLAS</div>
                                            ...
                                            <div class='table_row'>
                                                ...
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Description</div>
                                                    <div class='table_cell'>1 BED ROOM VILLA</div>
                                                </div>
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Group Type</div>
                                                    <div class='table_cell'>1 BED ROOM VILLA</div>
                                            ...
                                            <div class='table_row'>
                                                ...
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Description</div>
                                                    <div class='table_cell'> 1 BED</div>
                                                </div>
                                                <div class='table_small'>
                                                    <div class='table_cell'>Header Group Type</div>
                                                    <div class='table_cell'> 1 BED</div>
