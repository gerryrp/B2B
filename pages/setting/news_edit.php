...
<div class="container w-11/12 bg-gray-200 mx-auto p-5">
        ...
        <div class="container w-full">
            ...
            <div class="w-full border-0 border-b border-solid border-black">
                <div class="flex md-4">
                    <span class="span_title"><h2>Edit News</h2></span>           
                </div>
            </div>
        ...
        <div class="container w-full mt-5 ">
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-black p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            <input type="text" name="username" class="textarealg border border-black" value="PROMO MULIA BALI">
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-black p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            ...
                            <input type="text" name="username" class="textareasm border border-black" value=" 19 March 2019">
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-black p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            ...
                            <input type="text" name="username" class="textareasm border border-black" value=" 3 April 2019">
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-black p-2 ">
                        ...
                        <div class="w-8/12  text-xs md-4">
                            ...
                            <h3><span style="color:limegreen">MULIA RESORT NUSA DUA [*5]  </span><br/>
