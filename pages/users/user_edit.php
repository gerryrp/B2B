...
<div class="container w-11/12 bg-gray-200 mx-auto p-5">
        ...
        <div class="container w-full">
            ...
            <div class="w-full border-0 border-b border-solid border-gray-400">
                <div class="flex md-4">
                    <span class="span_title"><h2>Edit User</h2></span>           
                </div>
            </div>
        ...
        <div class="container w-full mt-5 ">
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="jambireservation@astonhotelsasia.com">
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="jambiinfo@astonhotelsasia.com">
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            <textarea rows="6" cols="40" class="border border-black rounded-lg"> Jl. Sultan Agung No. 99 Kel. Murni Telanai Pura - Jambi</textarea>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="Jambi"> 
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="+62 741 33 777">  
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="+62 741 33 999">  
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="TBA">  
                        </div>
                                ...
                                <div class="table" id="results">
                                        ...
                                        <div class='table_row'>
                                            ...
                                            <div class='table_small'>
                                                ...
                                                <div class='table_cell'>
                                                    <button onclick="window.location.href = '';" type="button" ><i class="fas fa-window-close"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class='table_row'>
                                            ...
                                            <div class='table_small'>
                                                <div class='table_cell'>Header Role Access</div>
                                                <div class='table_cell'>
                                                <button onclick="window.location.href = '';" class="btn btn-sm btn-rounded btn-light"> Add Role</button>
                                                </div>
                                            </div>
                                            <div class='table_small'>
                                                <div class='table_cell'>Header </div>
