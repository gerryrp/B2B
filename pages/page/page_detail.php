    ...
    <div class="container mt-5">
        <div class="flex md-4">
            ...
            <div class="flex w-4/12 items-center justify-end">
                ...
                <div>
                    <button onclick="window.location.href = '<?=root_path?>/pages/page/page_edit.php';" type="button" class="btn  btn-warning btn-sm btn-rounded mr-3  " value="Reset"><i class="fas fa-pencil-alt"></i> Edit</button> 
                </div>
                <div>
