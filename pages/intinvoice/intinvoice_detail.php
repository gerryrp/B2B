...
<div class="container bg-gray-200 mx-auto w-11/12 mt-10 p-5">
        ...
        <div class="w-full mt-8 bg-gray-200 border-0 border-b border-gray-500 ">
            <div>
                <span class="font-bold"><h2>Check-in: 17 March 2019 - Check-out: 18 March 2019 ~ 1 night(s)</h2></span>
            </div>

            <div class="table" id="results">

                <div class='theader'>
                    <div class='table_header'>Sun Booking No.</div>
                ...
                <div class='table_row'>
                    <div class='table_small'>
                        <div class='table_cell'>Header Sun Booking No.</div>
                    ...
                    <div class='table_small'>
                        <div class='table_cell'>Header Total</div>
