...
<div class="container w-11/12 bg-gray-200 mx-auto p-5">
        ...
        <div class="container w-full">
            ...
            <div class="w-full border-0 border-b border-solid border-gray-400">
                <div class="flex md-4">
                    <span class="span_title"><h2>Edit API User</h2></span>           
                </div>
            </div>
        ...
        <div class="container w-full mt-5 ">
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="backoffice">
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="Haryono Backoffice">
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                                <input type="text" class="textarealg border border-black" value="milhanol068@gmail.com">
                        </div>
                ...
                <div class="flex flex-wrap overflow-hidden bg-gray-100 border-0 border-b border-solid border-gray-400 p-2 ">
                        ...
                        <div class="w-1/2 items-center text-xs flex">
                            <textarea rows="6" cols="40" class="border border-black rounded-lg"></textarea>
